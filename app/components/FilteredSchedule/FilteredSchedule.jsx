...
import styles from "./FilteredSchedule.module.scss";

export default function FilteredSchedule({ schedule }) {
  const [chosenDay, setChosenDay] = React.useState(schedule[0].name);
